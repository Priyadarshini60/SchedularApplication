    ...
    public class UsersController : ApiController
    {
        ...
        public IHttpActionResult PostUser([FromBody]UserRegistrationModel userRegisteartionModel) //bind userRegistration model class
        {
            ...
            using (MailMessage mm = new MailMessage("priyankaa.shir1204@gmail.com", users.Email))  // use mail message class
            {
                ...
                body += "<br /><a href = 'http://localhost:63613/api/Users/VeryFiyAccount/" + code + "'>Click here to activate your account.</a>";  //append activation code with verify account url
                mm.Body = body;
                mm.IsBodyHtml = true;
