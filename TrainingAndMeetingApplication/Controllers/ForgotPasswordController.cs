...
namespace TrainingAndMeetingApplication.Controllers
{
    public class ForgotPasswordController : ApiController
    {
        ...
        public IHttpActionResult PostUser([FromBody]ForgotPasswordM forgotPassword) //bind userRegistration model class
        {
            ...
            using (MailMessage mm = new MailMessage("priyankaa.shir1204@gmail.com", users.Email))  // use mail message class
            {
                mm.Subject = "Account Activation";
                string body = "Hello " + users.FirstName + ",";
                body += "<br /><br />Please click the following link to Reset your password";
                body += "<br /><a href = 'http://localhost:63613/api/ForgotPassword/VeryFiyAccount/" + code + "'>Click here to activate your account.</a>";  //append activation code with verify account url
                mm.Body = body;
                mm.IsBodyHtml = true;
                SmtpClient smtp = new SmtpClient();
                smtp.Host = "smtp.gmail.com";   //use smtp host of gmail
                smtp.EnableSsl = true;
                NetworkCredential NetworkCred = new NetworkCredential("priyankaa.shir1204@gmail.com", "Priyanka@123");   //credential of mail senders mail account
